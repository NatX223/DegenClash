        ...
        <section className="relative flex min-h-[600px] flex-col items-center justify-center overflow-hidden px-4 py-20 text-center md:min-h-[700px]">
          ...
          <div className="relative z-10 flex max-w-4xl flex-col items-center gap-6">
            ...
            <h1 className="text-5xl font-black leading-tight tracking-tight text-white md:text-7xl lg:text-8xl">
              Predict. <span className="text-primary text-glow">Battle.</span>{" "}
              Win.
            </h1>

            <p className="max-w-2xl text-lg text-slate-400 md:text-xl">
              Experience the thrill of gamified crypto prediction markets.
              Engage in high-stakes 1v1 duels or join forces in team battles to
              dominate the market.
            </p>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mb-12 flex flex-col gap-4 text-center md:text-left">
              ...
              <p className="text-slate-400 max-w-2xl">
                Select your preferred game mode and start predicting market
                movements to win rewards in real-time.
              </p>
            </div>
              ...
              <div className="group relative overflow-hidden rounded-2xl glass-effect p-1 transition-all hover:border-primary/50">
                ...
                <div className="flex h-full flex-col rounded-xl bg-surface-dark">
                  <div className="relative h-64 w-full overflow-hidden rounded-t-xl bg-black">
                    ...
                    {/* Fake Chart Line */}
                    <svg
                      className="absolute bottom-0 left-0 w-full h-32 stroke-primary/30 fill-none"
                      preserveAspectRatio="none"
                      viewBox="0 0 400 100"
                    >
                      <path
                        d="M0,80 Q50,90 100,50 T200,60 T300,30 T400,10"
                        strokeWidth="2"
                      ></path>
                      <path
                        className="fill-primary/5 stroke-none"
                        d="M0,80 L400,10 L400,100 L0,100 Z"
                      ></path>
                    </svg>
                  </div>
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <p className="mb-6 flex-1 text-slate-400">
                      High-stakes duels where you challenge opponents directly.
                      Predict short-term price movements and double your entry
                      instantly.
                    </p>
                    <div className="flex items-center justify-between border-t border-white/5 pt-4">
                      <div className="flex -space-x-2">
                        ...
                        <div className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-surface-dark bg-surface-darker text-[10px] font-bold text-slate-400">
                          +1.2k
                        </div>
                      </div>
                      <a
                        className="flex items-center gap-1 text-sm font-bold text-primary hover:text-white transition-colors"
                        href="#"
                      >
                        Enter Arena
                        <svg
              ...
              <div className="group relative overflow-hidden rounded-2xl glass-effect p-1 transition-all hover:border-blue-500/50">
                ...
                <div className="flex h-full flex-col rounded-xl bg-surface-dark">
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <p className="mb-6 flex-1 text-slate-400">
                      Collaborate with squads to bet against rival teams. Pool
                      resources, strategize, and dominate the leaderboard for
                      massive pot shares.
                    </p>
                    <div className="flex items-center justify-between border-t border-white/5 pt-4">
                      <div className="flex items-center gap-2">
                      ...
                      <a
                        className="flex items-center gap-1 text-sm font-bold text-blue-400 hover:text-white transition-colors"
                        href="#"
                      >
                        Join Squad
                        <svg
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
              <div>
                ...
                <p className="text-slate-400">
                  The most successful predictors this week.
                </p>
              </div>
        ...
        <section className="relative px-4 py-24 text-center overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-3xl">
            ...
            <p className="mb-8 text-xl text-slate-300">
              Connect your wallet now and get a{" "}
              <span className="text-primary font-bold">100% deposit match</span>{" "}
              for your first 1v1 battle.
            </p>
        ...
        <div className="mx-auto max-w-7xl flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col gap-4 items-center md:items-start">
            ...
            <p className="text-sm text-slate-500 max-w-xs text-center md:text-left">
              The #1 gamified crypto prediction market. Predict right, earn
              rewards.
            </p>
          </div>
